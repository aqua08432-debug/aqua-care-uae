        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground">
              Get in touch with our water filtration experts. We're here to help you choose
              the perfect solution for your needs and answer any questions you may have.
            </p>
          </div>
        </div>
      </section>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        Al Quasis Ind. Area 1, Halab Street
                        <br />
                        Dubai - UAE
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="reseller">Become a Reseller</SelectItem>
      ...
      <section className="py-12 md:py-16 bg-muted/30">
        <div className="container">
          ...
          <div className="aspect-video bg-muted rounded-lg overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3607.5986!2d55.3798!3d25.2854!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjXCsDE3JzA3LjQiTiA1NcKwMjInNDcuMyJF!5e0!3m2!1sen!2sae!4v1234567890"
              width="600"
              height="450"
              ...
              title="Aqua Care Trading LLC Location Map - Al Quasis Dubai"
            ></iframe>
          </div>
        </div>
      </section>
